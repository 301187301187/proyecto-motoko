...
actor {
  ...
  // Función para convertir fecha y hora a Text
  public shared func fechaHoraToText(fecha: Text) : async Text {
    // Devuelve la fecha tal como está, ya que se asume que ya está en formato legible
    return fecha;
  };
}
